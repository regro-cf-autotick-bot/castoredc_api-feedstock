...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/castoredc_api-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13952&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/castoredc_api-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `castoredc_api` can be installed with:

```
conda install castoredc_api
```

It is possible to list all of the versions of `castoredc_api` available on your platform with:
